...
window.addEventListener('DOMContentLoaded', function () {
  ...
  oldOfficer.init();
  var newOfficer = new _modules_difference__WEBPACK_IMPORTED_MODULE_0__["default"]({
    officer: '.officernew',
    items: '.officer__card-item'
  });
  newOfficer.init();
  var letsHelpForm = new _modules_form__WEBPACK_IMPORTED_MODULE_1__["default"]({
    form: '.join__evolution form',
    url: './assets/question.php'
  });
  letsHelpForm.init();
  var selectTimeForm = new _modules_form__WEBPACK_IMPORTED_MODULE_1__["default"]({
...
/* harmony import */ var _services_requests__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./services/requests */ "./src/js/modules/services/requests.js");
  ...
  _createClass(SendForm, [{
    ...
    value: function sendData() {
      ...
      this.form.addEventListener('submit', function (e) {
        ...
        _this.status = document.createElement('div');
        _this.status.style.cssText = "\n                padding-top: 15px;\n                font-weight: bold;\n                font-size: 24px;\n            ";
        _this.status.innerHTML = _this.progress.loading;

        _this.form.parentNode.append(_this.status);

        Object(_services_requests__WEBPACK_IMPORTED_MODULE_8__["default"])(_this.url, _this.formData).then(function (res) {
          _this.status.innerHTML = _this.progress.success;
          console.log(res);
        }).catch(function (res) {
          _this.status.innerHTML = _this.progress.error;
          console.log(res);
        }).finally(function () {
          _this.clearInputs();
    ...
    value: function inputMask() {
      this.allPhoneInputs.forEach(function (phoneInput) {
        phoneInput.addEventListener('focus', function (e) {
          e.target.value = '+1 ';
        });
        phoneInput.addEventListener('input', function (e) {
          var x = e.target.value.replace(/\D/g, '').match(/(\d{0,1})(\d{0,3})(\d{0,3})(\d{0,4})/);
          e.target.value = '+1 ' + (!x[3] ? !x[2] ? x[2] : '(' + x[2] : '(' + x[2] + ') ' + x[3] + (x[4] ? '-' + x[4] : ''));
        });
      });
    }
  }, {
    ...
    value: function clearInputs() {
      Array.from(this.allInputs).forEach(function (input) {
        input.value = '';
      });
    }
  }, {
...
function (_Slider) {
  ...
  _createClass(MiniSlider, [{
    ...
    value: function filterSlides() {
      this.filteredSlides = this.slides.filter(function (slide) {
    ...
    value: function autoPlay() {
      ...
      if (this.autoPlay) {
        ...
        this.container.addEventListener('mouseleave', function () {
          _this3.sliderInterval = _this3.sliderInterval = setInterval(function () {
            return _this3.nextSlide();
          }, 5000);
        });
      }
    ...
    value: function prevSlide() {
      var active = this.filteredSlides[this.filteredSlides.length - 1];
