...
var showMoreStyles = function showMoreStyles(trigger, styles) {
  ...
  btn.addEventListener('click', function () {
    cards.forEach(function (element) {
      ...
      var strToArr = 'hidden-lg hidden-md hidden-sm hidden-xs styles-2'.split(' ');

      (_element$classList = element.classList).remove.apply(_element$classList, _toConsumableArray(strToArr));

      strToArr = 'col-sm-3 col-sm-offset-0 col-xs-10 col-xs-offset-1'.split(' ');

      (_element$classList2 = element.classList).add.apply(_element$classList2, _toConsumableArray(strToArr));
    });
    btn.remove();
  });
};
