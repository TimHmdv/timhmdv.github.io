...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_sliders__WEBPACK_IMPORTED_MODULE_11__["default"])('.feedback-slider-item', false, '.main-prev-btn', '.main-next-btn');
  Object(_modules_sliders__WEBPACK_IMPORTED_MODULE_11__["default"])('.main-slider-item', true, '.main-prev-btn', '.main-next-btn');
  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_5__["default"])(state);
  ...
  Object(_modules_calc__WEBPACK_IMPORTED_MODULE_2__["default"])('#size', '#material', '#options', '.promocode', '.calc-price', state);
...
var checkNumInputs = function checkNumInputs(input) {
...
var forms = function forms(state) {
  var allForms = document.querySelectorAll('form'),
      ...
      allUploads = document.querySelectorAll('[name="upload"]'); // checkNumInputs(phoneInputs);
  ...
  var clearInputs = function clearInputs() {
    ...
    allUploads.forEach(function (item) {
  ...
  allForms.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      var texMessage = document.createElement('div');
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  var btn = document.querySelector(trigger); // cards.forEach(element => {
  ...
  btn.addEventListener('click', function () {
    Object(_services_requests__WEBPACK_IMPORTED_MODULE_13__["getResource"])('http://localhost:3000/styles').then(function (res) {
      console.log(res);
      createCards(res);
  ...
  function createCards(response) {
    response.forEach(function (_ref) {
      ...
      var strToArr = 'col-sm-3 col-sm-offset-0 col-xs-10 col-xs-offset-1'.split(' ');

      (_card$classList = card.classList).add.apply(_card$classList, _toConsumableArray(strToArr));
...
var sliders = function sliders(slides, verticalDirection, previous, next) {
  var slideIndex = 1,
      paused = false;
